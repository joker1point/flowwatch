...
> 开源仓库:github.com/joker1point/flowwatch ｜ 本机路径:`frontend-works/flowwatch` ｜ 最近更新:2026-09-23(**v1.0.1 已发布**:一键包 + 免 Python exe;`84ca756` / tag `v1.0.1`)。
>
...
- **v1.0.1(09-21 已发布)**:Release 两个资产 —— `-windows.zip`(源码+预构建前端,双击 `start.cmd`)与 `-win64-exe.zip`(**免 Python**,双击 `flowwatch.exe`);两者都走**单端口 8791**、都需另装 **Npcap**(驱动级)
